...
CHAR8  ComputerSystemEmptyJson[] = "{\"@odata.id\": \"\", \"@odata.type\": \"#ComputerSystem.v1_22_0.ComputerSystem\", \"Id\": \"\", \"Name\": \"\", \"Boot\":{}}";
  ...
  )
{
  ...
  if (ComputerSystemCs->Boot == NULL) {
    ComputerSystemCs->Boot = AllocateZeroPool (sizeof (RedfishComputerSystem_V1_22_0_Boot_CS));
