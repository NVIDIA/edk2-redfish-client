...
# Definition of ComputerSystem.V1_22_0 and functions<br><br>
...
## Actions
    typedef struct _RedfishComputerSystem_V1_22_0_Actions_CS {
        ...
        RedfishComputerSystem_V1_22_0_OemActions_CS *Oem;
    } RedfishComputerSystem_V1_22_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**ComputerSystem_AddResourceBlock**|RedfishComputerSystem_V1_22_0_AddResourceBlock_CS| Structure points to **#ComputerSystem.AddResourceBlock** property.| No| No
|**ComputerSystem_Decommission**|RedfishComputerSystem_V1_22_0_Decommission_CS| Structure points to **#ComputerSystem.Decommission** property.| No| No
|**ComputerSystem_RemoveResourceBlock**|RedfishComputerSystem_V1_22_0_RemoveResourceBlock_CS| Structure points to **#ComputerSystem.RemoveResourceBlock** property.| No| No
|**ComputerSystem_Reset**|RedfishComputerSystem_V1_22_0_Reset_CS| Structure points to **#ComputerSystem.Reset** property.| No| No
|**ComputerSystem_SetDefaultBootOrder**|RedfishComputerSystem_V1_22_0_SetDefaultBootOrder_CS| Structure points to **#ComputerSystem.SetDefaultBootOrder** property.| No| No
|**Oem**|RedfishComputerSystem_V1_22_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## BootProgress
    typedef struct _RedfishComputerSystem_V1_22_0_BootProgress_CS {
        RedfishCS_int64 *LastBootTimeSeconds;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**LastBootTimeSeconds**|RedfishCS_int64| 64-bit long long interger pointer to **LastBootTimeSeconds** property.| No| Yes
...
## Composition
    typedef struct _RedfishComputerSystem_V1_22_0_Composition_CS {
        RedfishCS_char_Array *UseCases;
    } RedfishComputerSystem_V1_22_0_Composition_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**UseCases**|RedfishCS_char_Array| Structure array points to one or more than one **RedfishCS_char *** for property **UseCases**.| No| Yes
...
## HostSerialConsole
    typedef struct _RedfishComputerSystem_V1_22_0_HostSerialConsole_CS {
        RedfishComputerSystem_V1_22_0_SerialConsoleProtocol_CS *IPMI;
        RedfishCS_int64 *MaxConcurrentSessions;
        RedfishComputerSystem_V1_22_0_SerialConsoleProtocol_CS *SSH;
        RedfishComputerSystem_V1_22_0_SerialConsoleProtocol_CS *Telnet;
    } RedfishComputerSystem_V1_22_0_HostSerialConsole_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**IPMI**|RedfishComputerSystem_V1_22_0_SerialConsoleProtocol_CS| Structure points to **IPMI** property.| No| No
|**MaxConcurrentSessions**|RedfishCS_int64| 64-bit long long interger pointer to **MaxConcurrentSessions** property.| No| Yes
|**SSH**|RedfishComputerSystem_V1_22_0_SerialConsoleProtocol_CS| Structure points to **SSH** property.| No| No
|**Telnet**|RedfishComputerSystem_V1_22_0_SerialConsoleProtocol_CS| Structure points to **Telnet** property.| No| No
...
## KMIPServer
    typedef struct _RedfishComputerSystem_V1_22_0_KMIPServer_CS {
        ...
        RedfishCS_char *CacheDuration;
        RedfishCS_char *CachePolicy;
...
|**CacheDuration**|RedfishCS_char| String pointer to **CacheDuration** property.| No| No
|**CachePolicy**|RedfishCS_char| String pointer to **CachePolicy** property.| No| No
...
## KeyManagement
    typedef struct _RedfishComputerSystem_V1_22_0_KeyManagement_CS {
        ...
        RedfishComputerSystem_V1_22_0_KMIPServer_Array_CS *KMIPServers;
...
|**KMIPServers**|RedfishComputerSystem_V1_22_0_KMIPServer_Array_CS| Structure array points to one or more than one **RedfishComputerSystem_V1_22_0_KMIPServer_Array_CS** structures for property **KMIPServers**.| No| No
...
## Links
    typedef struct _RedfishComputerSystem_V1_22_0_Links_CS {
        ...
        RedfishCS_Link HostingComputerSystem;
        ...
        RedfishCS_Link TrustedComponents;
        RedfishCS_int64 *TrustedComponentsodata_count;
        RedfishCS_Link VirtualMachines;
...
|**HostingComputerSystem**|RedfishCS_Link| Structure link list to **HostingComputerSystem** property.| No| Yes
...
|**TrustedComponents**|RedfishCS_Link| Structure link list to **TrustedComponents** property.| No| Yes
|**TrustedComponentsodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **TrustedComponents@odata.count** property.| No| No
|**VirtualMachines**|RedfishCS_Link| Structure link list to **VirtualMachines** property.| No| Yes
|**VirtualMachinesodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **VirtualMachines@odata.count** property.| No| No
...
## Condition
    typedef struct _RedfishResource_Condition_CS {
        ...
        RedfishCS_Link ResolutionSteps;
...
|**ResolutionSteps**|RedfishCS_Link| Structure link list to **ResolutionSteps** property.| No| No
...
## ComputerSystem
    typedef struct _RedfishComputerSystem_V1_22_0_ComputerSystem_CS {
        ...
        RedfishComputerSystem_V1_22_0_Actions_CS *Actions;
        RedfishCS_char *AssetTag;
        RedfishCS_Link Bios;
        RedfishCS_char *BiosVersion;
        RedfishComputerSystem_V1_22_0_Boot_CS *Boot;
        RedfishComputerSystem_V1_22_0_BootProgress_CS *BootProgress;
        RedfishCS_Link Certificates;
        RedfishComputerSystem_V1_22_0_Composition_CS *Composition;
        RedfishCS_char *Description;
        RedfishCS_Link EthernetInterfaces;
        RedfishCS_Link FabricAdapters;
        RedfishComputerSystem_V1_22_0_HostGraphicalConsole_CS *GraphicalConsole;
        RedfishCS_Link GraphicsControllers;
        RedfishCS_char *HostName;
        RedfishComputerSystem_V1_22_0_WatchdogTimer_CS *HostWatchdogTimer;
        RedfishComputerSystem_V1_22_0_HostedServices_CS *HostedServices;
        RedfishCS_char *HostingRoles;
        RedfishCS_char *Id;
        RedfishComputerSystem_V1_22_0_IdlePowerSaver_CS *IdlePowerSaver;
        RedfishCS_char *IndicatorLED;
        RedfishComputerSystem_V1_22_0_KeyManagement_CS *KeyManagement;
        RedfishCS_char *LastResetTime;
        RedfishComputerSystem_V1_22_0_Links_CS *Links;
        RedfishCS_bool *LocationIndicatorActive;
        RedfishCS_Link LogServices;
        RedfishCS_char *Manufacturer;
        RedfishCS_bool *ManufacturingMode;
        RedfishCS_Link Measurements;
        RedfishCS_Link Memory;
        RedfishCS_Link MemoryDomains;
        RedfishComputerSystem_V1_22_0_MemorySummary_CS *MemorySummary;
        RedfishCS_char *Model;
        RedfishCS_char *Name;
        RedfishCS_Link NetworkInterfaces;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_Link OperatingSystem;
        ...
        RedfishComputerSystem_V1_22_0_ProcessorSummary_CS *ProcessorSummary;
        RedfishCS_Link Processors;
        RedfishCS_Link Redundancy;
        RedfishCS_int64 *Redundancyodata_count;
        RedfishCS_char *SKU;
        RedfishCS_Link SecureBoot;
        RedfishComputerSystem_V1_22_0_HostSerialConsole_CS *SerialConsole;
        ...
        RedfishComputerSystem_V1_22_0_TrustedModules_CS *TrustedModules;
        RedfishCS_Link USBControllers;
        RedfishCS_char *UUID;
        RedfishCS_Link VirtualMedia;
        RedfishComputerSystem_V1_22_0_VirtualMediaConfig_CS *VirtualMediaConfig;
...
|**Actions**|RedfishComputerSystem_V1_22_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Boot**|RedfishComputerSystem_V1_22_0_Boot_CS| Structure points to **Boot** property.| No| No
|**BootProgress**|RedfishComputerSystem_V1_22_0_BootProgress_CS| Structure points to **BootProgress** property.| No| No
|**Certificates**|RedfishCS_Link| Structure link list to **Certificates** property.| No| Yes
|**Composition**|RedfishComputerSystem_V1_22_0_Composition_CS| Structure points to **Composition** property.| No| No
...
|**GraphicalConsole**|RedfishComputerSystem_V1_22_0_HostGraphicalConsole_CS| Structure points to **GraphicalConsole** property.| No| No
...
|**HostWatchdogTimer**|RedfishComputerSystem_V1_22_0_WatchdogTimer_CS| Structure points to **HostWatchdogTimer** property.| No| No
|**HostedServices**|RedfishComputerSystem_V1_22_0_HostedServices_CS| Structure points to **HostedServices** property.| No| No
|**HostingRoles**|RedfishCS_char| String pointer to **HostingRoles** property.| No| Yes
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**IdlePowerSaver**|RedfishComputerSystem_V1_22_0_IdlePowerSaver_CS| Structure points to **IdlePowerSaver** property.| No| No
|**IndicatorLED**|RedfishCS_char| String pointer to **IndicatorLED** property.| No| No
|**KeyManagement**|RedfishComputerSystem_V1_22_0_KeyManagement_CS| Structure points to **KeyManagement** property.| No| No
|**LastResetTime**|RedfishCS_char| String pointer to **LastResetTime** property.| No| Yes
|**Links**|RedfishComputerSystem_V1_22_0_Links_CS| Structure points to **Links** property.| No| No
...
|**ManufacturingMode**|RedfishCS_bool| Boolean pointer to **ManufacturingMode** property.| No| Yes
...
|**MemorySummary**|RedfishComputerSystem_V1_22_0_MemorySummary_CS| Structure points to **MemorySummary** property.| No| No
|**Model**|RedfishCS_char| String pointer to **Model** property.| No| Yes
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**NetworkInterfaces**|RedfishCS_Link| Structure link list to **NetworkInterfaces** property.| No| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**OperatingSystem**|RedfishCS_Link| Structure link list to **OperatingSystem** property.| No| Yes
...
|**ProcessorSummary**|RedfishComputerSystem_V1_22_0_ProcessorSummary_CS| Structure points to **ProcessorSummary** property.| No| No
...
|**SerialConsole**|RedfishComputerSystem_V1_22_0_HostSerialConsole_CS| Structure points to **SerialConsole** property.| No| No
...
|**TrustedModules**|RedfishComputerSystem_V1_22_0_TrustedModules_CS| Structure points to **TrustedModules** property.| No| No
...
|**VirtualMediaConfig**|RedfishComputerSystem_V1_22_0_VirtualMediaConfig_CS| Structure points to **VirtualMediaConfig** property.| No| No
## Redfish ComputerSystem V1_22_0 to C Structure Function
    RedfishCS_status
    Json_ComputerSystem_V1_22_0_To_CS (RedfishCS_char *JsonRawText, RedfishComputerSystem_V1_22_0_ComputerSystem_CS **ReturnedCS);

## C Structure to Redfish ComputerSystem V1_22_0 JSON Function
    RedfishCS_status
    CS_To_ComputerSystem_V1_22_0_JSON (RedfishComputerSystem_V1_22_0_ComputerSystem_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ComputerSystem V1_22_0 C Structure Function
    RedfishCS_status
