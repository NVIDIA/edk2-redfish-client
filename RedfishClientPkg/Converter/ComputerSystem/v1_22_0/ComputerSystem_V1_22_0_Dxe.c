...
// Support ComputerSystem V1_22_0
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_22_0     *ComputerSystemV1_22_0;
  EFI_REDFISH_COMPUTERSYSTEM_V1_22_0_CS  *ComputerSystemV1_22_0Cs;
      ...
      )
  {
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.MinorVersion, "22") != 0) ||
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_22_0_To_CS (ResoruceRaw, &ComputerSystemV1_22_0Cs);
  if (EFI_ERROR (Status)) {
    return Status;
  }

  ComputerSystemV1_22_0 = (EFI_REDFISH_COMPUTERSYSTEM_V1_22_0 *)AllocateZeroPool (
                                                                  sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_22_0)
                                                                  );
  if (ComputerSystemV1_22_0 == NULL) {
    return EFI_OUT_OF_RESOURCES;
  }

  RestIntrpHeader                       = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_22_0;
  ComputerSystemV1_22_0->ComputerSystem = ComputerSystemV1_22_0Cs;
  ResourceTypeMajorVersion              = "1";
  ResourceTypeMinorVersion              = "22";
  ...
  )
{
  ...
  DEBUG ((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_22_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_22_0_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_22_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR (RedfishStatus)) {
    DEBUG ((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_22_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  ...
  )
{
  ...
  ComputerSystemV1_22_0 = (EFI_REDFISH_COMPUTERSYSTEM_V1_22_0 *)InterpProp;
  DestroyComputerSystem_V1_22_0_CS (ComputerSystemV1_22_0->ComputerSystem);
  return EFI_SUCCESS;
}
  ...
  )
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_22_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_22_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_22_0Unload (
  IN EFI_HANDLE  ImageHandle
  )
{
  //
